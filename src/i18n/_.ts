const def = {
    ...
    player: {
        ...
        chat: {
            ...
            message: {
                ...
                changedSource: 'changed the video',
            },
        },
    ...
    sync: {
        offline: 'No connection to the room',
        clockUnsynced: 'Clock not synchronized — your actions are not shared',
        writeRejected: 'The room rejected the change',
        failed: 'Something went wrong. Reload the app',
    },
